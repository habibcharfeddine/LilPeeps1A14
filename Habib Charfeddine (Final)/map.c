...
void mapCollision2(GameObject *entity)
{
    ...
    for (;;)
    {
        ...
        if (x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
        {
            ...
            if (entity->dirX > 0)
            {
                ...
                {
                    //On appelle la fonction getItem()
                    getItem2(map.tile[y1][x2] - TILE_POWER_UP_DEBUT + 1);
                ...
                {
                    //On appelle la fonction getItem()
                    getItem2(map.tile[y2][x2] - TILE_POWER_UP_DEBUT + 1);
            ...
            else if (entity->dirX < 0)
            {
                ...
                {
                    //On appelle la fonction getItem()
                    getItem2(map.tile[y1][x1] - TILE_POWER_UP_DEBUT + 1);
                ...
                {
                    //On appelle la fonction getItem()
                    getItem2(map.tile[y2][x1] - TILE_POWER_UP_DEBUT + 1);
