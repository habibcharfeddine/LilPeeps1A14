...
void drawStartMenu(SDL_Surface *screen, int *sound, int *fullscreen)
{
	...
	back=SDL_DisplayFormatAlpha(IMG_Load("menu/background.png")); //background
	...
	retour=SDL_DisplayFormatAlpha(IMG_Load("menu/fleche retour.png")); //flèche de retour
	retour_appui=SDL_DisplayFormatAlpha(IMG_Load("menu/fleche retour appui.png"));//flèche de retour rouge
